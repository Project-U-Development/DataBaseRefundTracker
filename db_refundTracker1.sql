...
insert into refunds values (1, '2022-01-01', 'shoes', 'Nike', 20.99, 'euro', '2024-06-01', 1, 3, 0);
...
insert into refunds values (2, '2022-01-02', 'dress', 'Dresscompany', 17.50, 'usd', '2024-05-02', 2, 1, 0);
insert into refunds values (3, '2022-01-03', 'socks', 'madeByMom', 7.45, 'cad', '2024-09-03', 5, 2, 0);
insert into refunds values (4, '2022-01-04', 'bedlinen', 'SleepNice', 75.80, 'euro', '2024-06-17', 3, 6, 0);
insert into refunds values (5, '2022-02-19', 'mobile', 'Apple', 1299.90, 'usd', '2024-03-23', 4, 1, 0);
insert into refunds values (6, '2022-03-26', 'flightMadrid', 'Wizzair', 578.20, 'euro', '2024-04-23', 7, 5, 0);
insert into refunds values (7, '2022-03-28', 'hummer', 'KitchenCo', 255.90, 'uah', '2024-07-15', 6, 4, 0);
insert into refunds values (8, '2022-06-10', 'pillow', 'SleepNice', 45.20, 'euro', '2024-02-13', 8, 7, 0);
insert into refunds values (9, '2022-04-17', 'jacket', 'Jacketcompany', 85.99, 'usd', '2024-04-25', 9, 8, 0);
insert into refunds values (10, '2022-04-09', 'jeans', 'Dresscompany', 34.00, 'usd', '2024-05-16', 10,  9, 0);
